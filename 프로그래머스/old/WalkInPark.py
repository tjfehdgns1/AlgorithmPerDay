...
def solution(park, routes):
    ...
    for route in routes:
        ...
        if (
            position[0] + four_directions[direction][0] * num < max_x
            or position[1] + four_directions[direction][1] * num < max_y
        ):
